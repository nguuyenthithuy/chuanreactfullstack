...
class HomeHeader extends Component {
    ...
    render() {
        let languge = this.props.language
                    ...
                    <div className='home-header-content'>
                        ...
                        <div className='center-content'>
                            <div className='child-content'>
                                ...
                                <div className='subs-content'><FormattedMessage id="homeheader.searchdocter" /></div>
                            </div>

                            <div className='child-content'>
                                <div><b><FormattedMessage id="homeheader.infrastructure" /></b></div>
                                <div className='subs-content'><FormattedMessage id="homeheader.selectedroom" /></div>
                            </div>

                            <div className='child-content'>
                                <div><b><FormattedMessage id="homeheader.doctor" /></b></div>
                                <div className='subs-content'><FormattedMessage id="homeheader.selecteddoctor" /></div>
                            </div>

                            <div className='child-content'>
                                <div><b><FormattedMessage id="homeheader.package" /></b></div>
                                <div className='subs-content'><FormattedMessage id="homeheader.health" /></div>
                            </div>
                        </div>
                        <div className='right-content'>
                            <div className='support'><i className='fas fa-question-circle'></i> <FormattedMessage id="homeheader.support" /></div>
                            <div className={languge === LANGUAGES.VI ? 'language-vi active' : 'language-vi'}><span onClick={() => this.changeLanguage(LANGUAGES.VI)}>VI</span></div>
                            <div className={languge === LANGUAGES.EN ? 'language-en active' : 'language-en'}><span onClick={() => this.changeLanguage(LANGUAGES.EN)}>EN</span></div>
                        </div>
